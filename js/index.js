...
function websdkready() {
   ...
   */
  var API_SECRET = "xxxxxxxxxxxxxxx";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/Users/user/Desktop/새%20폴더/meeting.html?" + testTool.serialize(meetingConfig); //local에서 테스트시 경로에 주의
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "/Users/user/Desktop/새%20폴더/meeting.html?" + //local에서 테스트시 경로에 주의
